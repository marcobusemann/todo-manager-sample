...
#include <moderngrids\qobservablevariantlistproxy.h>

class QObservableVariantListProxyTest : public QObject
{
    Q_OBJECT
...
QTEST_APPLESS_MAIN(QObservableVariantListProxyTest)

#include "QObservableVariantListProxyTest.moc"
